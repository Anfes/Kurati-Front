    ...
    return (
        <div>
            ...
            <div className="flex flex-col border-1 border-primaryBlack rounded-8 px-28 py-12">
                <div className="flex sm:flex-row flex-col my-16">
                    ...
                    <div className='sm:mx-12 mx-0 sm:my-0 my-8'>
                        <CustomToggleButtons
                            ...
                            selectedLeft={form.personType === 1 ? true : false} // 1: natural
                            selectedRight={form.personType === 2 ? true : false} // 2: juridico
                        />
                    </div>
                    {form.personType === 2 ? <div className='flex sm:mx-12 mx-0 my-8'>
                        <div className='sm:mx-14 mr-8'>
                            <CustomCheckBox
                                label='Pública'
                                rounded
                                checked={form.personType2 === 1 ? true : false} // 1: Pública
                        ...
                        <div className='sm:mx-14 mx-0'>
                            <CustomCheckBox
                                label='Privada'
                                rounded
                                checked={form.personType2 === 2 ? true : false} //  2: Privada
...
tributaria (NIT), personería jurídica, cédula de extranjería o pasaporte, con su respectivo número.' placement='top'>
                                            <IconButton  >
                                                <HelpOutlineIcon style={{ color: '#145C9C' }} />
                                            </IconButton>
                                        </Tooltip>
                ...
                <div className="w-full md:my-16 my-8 md:my-0">
                    <CustomTextField
                        ...
                        helperText={emailCorrect === false && error ? "Ingrese un email valido" : ''}
                    />
                </div>
                <div className='mb-16'>
                    <Typography className='font-bold text-14 my-12'>¿Autoriza la notificación mediante email?</Typography>
                    <div className='flex sm:flex-row flex-col  items-center'>
                        ...
                        <div className=" md:ml-12 w-full" >
                            <CustomTextField
                                ...
                                label='Dirección notificación física '
                                value={form.addressNot}
                                disabled={form.autNot === 0}
                            />
                        </div>
                    </div>
                </div>
...
poseedor del predio, según sea el caso, de acuerdo con el artículo 2.2.3.2.9.2 del Decreto 1076 de 2015 y el Código Civil Colombiano.' placement='top'>
                            <IconButton>
                                <HelpOutlineIcon style={{ color: '#145C9C' }} />
                            </IconButton>
                        </Tooltip>
