...
const Validacion = (props) => {
 const {setFormFirma, formFirma} = props;
    ...
    const [codeEmp, setCodeEmpty] = useState(true);
...
if(text1 !== '' && text2 !== '' && text3 !== '' && text4 !== ''){
    if(formFirma.codigo !== text1+text2+text3+text4){
        setFormFirma({...formFirma, codigo:text1+text2+text3+text4})
    }
}

}, [setCode,text1,text2,text3,text4,setFormFirma, formFirma, codeEmpty]);
...
if(counterStart){
    ...
    return (
        <div className="flex flex-col w-full">
            <div className="flex flex-col justify-center border-1 border-primaryBlack rounded-8 p-28 w-full items-center">
